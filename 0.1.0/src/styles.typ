...
#let cover-style(body, lang: "en", layout: default-layout) = {
  set page(
    paper: layout.paper.at(lang).size,
    margin: 10%,
  )
  body
...
#let common-style(body, list-indent: indent-base, lang: "en", layout: default-layout) = {
  set list(indent: list-indent)
  set enum(indent: list-indent)
  set page(paper: layout.paper.at(lang).size, margin: 10%)
...
#let front-matter-style(body, lang: "en", layout: default-layout) = {
  set page(paper: layout.paper.at(lang).size, margin: 10%)
...
#let contents-style(body, lang: "en", layout: default-layout, depth: 2) = {
  set page(paper: layout.paper.at(lang).size, margin: 10%)
